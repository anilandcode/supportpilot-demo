...
## Corpus Check
- 237 files · ~180,628 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1987 nodes · 3989 edges · 102 communities (94 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `db4f3080`
...
1. `createSupabaseAdminClient()` - 110 edges
...
- `PortalPage()` --calls--> `listTickets()`  [EXTRACTED]
...
Cohesion: 0.11
Nodes (14): ConfidenceMeter(), ConfidenceMeterProps, SourceDrawer(), SourceDrawerProps, STATUS_STYLES, StatusBadge(), StatusBadgeProps, TicketAiPanelProps (+6 more)
...
Cohesion: 0.21
Nodes (10): ApprovalsPage(), metadata, TABS, listAuditLogs(), listTickets(), ApprovalAuditTimeline(), ApprovalAuditTimelineProps, TicketAiPanel() (+2 more)
...
Cohesion: 0.05
Nodes (41): AgentRun, AIFeedback, AuditLog, Customer, DashboardMetrics, DeletionRequestStatus, DomainHealthStatus, EscalationRule (+33 more)
...
Cohesion: 0.07
Nodes (40): appendFeedback(), contentHash(), createMissingKnowledgeTask(), createPortalTicket(), getWorkspaceDomainFromSupabase(), hydrateSupabaseTicket(), hydrateTicket(), localState (+32 more)
...
Cohesion: 0.06
Nodes (75): AuditExportSchema, GET(), POST(), buildPayload(), createIngestionJob(), CreateIngestionJobInput, enqueueWithQStash(), extractJobText() (+67 more)

### Community 63 - "Community 63"
Cohesion: 0.09
Nodes (39): getChunksForReembedding(), listEmbeddingJobs(), localEmbeddingJobs, mapDocumentChunk(), maybeUuid(), publicId(), runReembeddingJob(), toEmbeddingJobRow() (+31 more)
...
Cohesion: 0.25
Nodes (20): acceptSchema, POST(), createInviteToken(), hashInviteToken(), inviteUrlFromRequest(), canManageMembershipMutation(), canInviteRole(), DELETE() (+12 more)

### Community 71 - "Community 71"
Cohesion: 0.12
Nodes (18): MembershipMutationDecision, ADMIN_ROLES, APPROVAL_ROLES, AuthPersona, canAccessAnyRole(), canApproveDraft(), canPerformMembershipAction(), decideAdminRouteAccess() (+10 more)
...
Cohesion: 0.19
Nodes (14): getWorkspaceHealth(), getWorkspaceLaunchState(), listApprovalPolicies(), listApprovalQueue(), listMissingKnowledgeTasks(), listSecurityEvents(), listToolDefinitions(), listWorkspaceChecklist() (+6 more)

### Community 77 - "Community 77"
Cohesion: 0.16
Nodes (17): canPerformMembershipAction(), CurrentWorkspaceMembership, getCurrentEnterpriseUser, getCurrentWorkspaceMembership, hasEnterpriseRole(), hasWorkspacePermission(), profileRoleToMembershipRole(), ROLE_RANK (+9 more)
...
Cohesion: 0.19
Nodes (19): clientKey(), GET(), appendSecurityEvent(), createWidgetSession(), getWidgetConfig(), isOriginAllowed(), mapWidgetConfig(), rateLimitHeaders() (+11 more)
...
Cohesion: 0.2
Nodes (13): CaptureInput, captureProductEvent(), requireTicketWorkspaceRole(), appendTicketMessage(), getTicket(), POST(), EscalationEmailSchema, POST() (+5 more)
...
Cohesion: 0.17
Nodes (13): ApiAuthResult, ensurePortalIdentity(), getAuthenticatedUser(), requireWorkspaceRole(), BodySchema, POST(), STEPS, completeOnboardingStep() (+5 more)
...
Cohesion: 0.13
Nodes (17): makeUniqueSlug(), makeWidgetKey(), ONBOARDING_CHECKLIST, slugifyWorkspaceName(), apiDemoFallbackFiles, apiFiles, checks, invitationRouteSource (+9 more)
...
## Knowledge Gaps
- **798 isolated node(s):** `config`, `config`, `SupportPilotTheme`, `nextConfig`, `metadata` (+793 more)
...
- **Why does `createSupabaseAdminClient()` connect `Community 70` to `Community 1`, `Community 7`, `Community 15`, `Community 31`, `Community 49`, `Community 52`, `Community 61`, `Community 62`, `Community 63`, `Community 66`, `Community 69`, `Community 74`, `Community 76`, `Community 77`, `Community 79`, `Community 80`, `Community 83`, `Community 85`, `Community 86`, `Community 90`, `Community 96`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `getWorkspace()` connect `Community 62` to `Community 1`, `Community 66`, `Community 69`, `Community 70`, `Community 74`, `Community 76`, `Community 77`, `Community 15`, `Community 80`, `Community 81`, `Community 49`, `Community 83`, `Community 85`, `Community 63`, `Community 31`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `requireWorkspaceRole()` connect `Community 85` to `Community 1`, `Community 70`, `Community 71`, `Community 74`, `Community 76`, `Community 77`, `Community 79`, `Community 80`, `Community 83`, `Community 86`, `Community 31`, `Community 62`, `Community 63`?**
