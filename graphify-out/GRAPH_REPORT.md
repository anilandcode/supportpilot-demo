...
## Corpus Check
- 231 files · ~175,133 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1910 nodes · 3776 edges · 93 communities (86 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ff798314`
...
2. `getWorkspace()` - 87 edges
3. `requireWorkspaceRole()` - 50 edges
4. `appendAuditLog()` - 32 edges
5. `POST()` - 28 edges
6. `cn()` - 26 edges
...
- `POST()` --calls--> `processRetentionJob()`  [INFERRED]
  app/api/knowledge/ingest/jobs/[jobId]/run/route.ts → lib/db/retention.ts
- `POST()` --calls--> `createMissingKnowledgeTask()`  [EXTRACTED]
...
Cohesion: 0.14
Nodes (22): AdminPage(), AnalyticsPage(), ApprovalsPage(), calculateMetrics(), getDashboardMetrics(), getWorkspaceHealth(), getWorkspaceLaunchState(), listApprovalPolicies() (+14 more)
...
Cohesion: 0.08
Nodes (26): contentHash(), getWorkspaceDomainFromSupabase(), hydrateSupabaseTicket(), localState, mapCustomer(), mapDocumentChunk(), mapTicket(), mapUser() (+18 more)

### Community 24 - "Community 24"
Cohesion: 0.06
Nodes (49): checklist, demoAgentRuns, demoAiRuns, demoAuditLogs, demoChecklistItems, demoCustomers, demoDocumentChunks, demoDomains (+41 more)
...
Cohesion: 0.05
Nodes (44): ModelRouteDecision, RouteInput, demoUsers, AgentRun, AIFeedback, ApprovalPolicy, AuditLog, ConfidenceBreakdown (+36 more)
...
Cohesion: 0.05
Nodes (82): getAuthenticatedUser(), getBillingPlans(), BillingPage(), BILLING_PLAN_KEY_BY_TIER, createStripeCheckoutSession(), createStripeCustomer(), createStripePortalSession(), dashboardBillingUrl() (+74 more)
...
Cohesion: 0.16
Nodes (30): listIngestionJobs(), appendAgentRun(), appendAuditLog(), appendFeedback(), appendGroundingCheck(), appendPolicyEvaluation(), appendTicketMessage(), appendToolCall() (+22 more)
...
Cohesion: 0.07
Nodes (48): AuditExportSchema, GET(), POST(), countOlderThan(), createAuditEvidenceExport(), createDeletionRequest(), CreateDeletionRequestInput, CreateEvidenceExportInput (+40 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (61): getChunksForReembedding(), localEmbeddingJobs, mapDocumentChunk(), maybeUuid(), publicId(), runReembeddingJob(), toEmbeddingJobRow(), updateChunkEmbedding() (+53 more)
...
Cohesion: 0.1
Nodes (12): metadata, RootLayout(), SuggestedQuestionsProps, SupportPilotTheme, LINKS, getThemeCssVariables(), ThemeStyle, ask() (+4 more)
...
Cohesion: 0.07
Nodes (50): acceptSchema, POST(), createInviteToken(), hashInviteToken(), inviteUrlFromRequest(), makeUniqueSlug(), makeWidgetKey(), ONBOARDING_CHECKLIST (+42 more)
...
Cohesion: 0.14
Nodes (21): requireWorkspaceRole(), hasEnterpriseRole(), listEmbeddingJobs(), addWorkspaceDomain(), domainVerificationRecord(), isOriginAllowed(), listWorkspaceDomains(), normalizeDomain() (+13 more)
...
Cohesion: 0.16
Nodes (8): listKnowledgeDocs(), listMissingKnowledgeTasks(), daysOld(), KnowledgePage(), metadata, GET(), MissingKnowledgeSchema, POST()
...
Cohesion: 0.13
Nodes (32): clientKey(), GET(), appendSecurityEvent(), getWidgetConfig(), mapWidgetConfig(), bucketKey(), checkMemoryRateLimit(), checkRateLimit() (+24 more)

### Community 81 - "Community 81"
Cohesion: 0.16
Nodes (28): estimateTokenCount(), selectModelRoute(), assistantResponse(), containsSensitiveData(), getClientKey(), getTextContent(), ipHash(), localAnswer() (+20 more)
...
Cohesion: 0.27
Nodes (11): ApiAuthResult, ensurePortalIdentity(), requireTicketWorkspaceRole(), getTicket(), hydrateTicket(), POST(), POST(), TicketMessageSchema (+3 more)
...
Cohesion: 0.29
Nodes (7): CaptureInput, captureProductEvent(), EscalationEmailSchema, POST(), UsageEventType, EscalationEmailInput, sendEscalationEmail()
...
## Knowledge Gaps
- **762 isolated node(s):** `config`, `config`, `SupportPilotTheme`, `nextConfig`, `metadata` (+757 more)
...
- **Why does `createSupabaseAdminClient()` connect `Community 49` to `Community 0`, `Community 1`, `Community 4`, `Community 71`, `Community 7`, `Community 74`, `Community 76`, `Community 80`, `Community 81`, `Community 83`, `Community 52`, `Community 85`, `Community 23`, `Community 31`, `Community 62`, `Community 63`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `getWorkspace()` connect `Community 49` to `Community 0`, `Community 1`, `Community 4`, `Community 7`, `Community 74`, `Community 80`, `Community 81`, `Community 63`, `Community 83`, `Community 85`, `Community 23`, `Community 93`, `Community 62`, `Community 31`?**
