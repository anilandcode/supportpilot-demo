...
## Corpus Check
- 238 files · ~183,737 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2032 nodes · 4126 edges · 104 communities (96 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8111b4da`
...
Cohesion: 0.06
Nodes (70): AccountSchema, GET(), integrationLimitBlock(), POST(), redactAccount(), redactConfig(), redactEndpoint(), WebhookEndpointSchema (+62 more)
...
Cohesion: 0.16
Nodes (17): AdminPage(), calculateMetrics(), getDashboardMetrics(), getWorkspaceHealth(), getWorkspaceLaunchState(), listApprovalPolicies(), listApprovalQueue(), listMissingKnowledgeTasks() (+9 more)
...
Cohesion: 0.05
Nodes (35): apiDemoFallbackFiles, apiFiles, authApiSource, billingCheckoutSource, billingCoreSource, billingPortalSource, billingSubscriptionSource, chatRouteSource (+27 more)
...
Cohesion: 0.07
Nodes (27): AIFeedback, ApprovalPolicy, DashboardMetrics, DeletionRequestStatus, DomainHealthStatus, EnterpriseUser, EscalationRule, IntegrationDeliveryStatus (+19 more)
...
Cohesion: 0.05
Nodes (79): BILLING_PLAN_KEY_BY_TIER, createStripeCheckoutSession(), createStripeCustomer(), createStripePortalSession(), dashboardBillingUrl(), deriveBillingEntitlementLimits(), firstSubscriptionPrice(), getBillingCatalog() (+71 more)
...
Cohesion: 0.29
Nodes (9): GET(), POST(), createSupabaseBrowserClient(), getAppMode(), getMissingSupabaseConfig(), getSupabaseAnonKey(), getSupabaseUrl(), SupportPilotAppMode (+1 more)
...
Cohesion: 0.11
Nodes (21): appendFeedback(), createMissingKnowledgeTask(), maybeUuid(), toAgentRunRow(), toAiRunRow(), toFeedbackRow(), toGroundingCheckRow(), toKnowledgeDocRow() (+13 more)
...
Cohesion: 0.08
Nodes (44): AuditExportSchema, GET(), POST(), clampRetentionDays(), createAuditEvidenceExport(), createDeletionRequest(), CreateDeletionRequestInput, CreateEvidenceExportInput (+36 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (71): getProjectedPlanLimitBlock(), getChunksForReembedding(), listEmbeddingJobs(), localEmbeddingJobs, mapDocumentChunk(), maybeUuid(), publicId(), runReembeddingJob() (+63 more)
...
Cohesion: 0.15
Nodes (25): createKnowledgeDocument(), bucketKey(), checkMemoryRateLimit(), checkRateLimit(), checkRedisRateLimit(), DEFAULT_LIMITS, globalForRateLimit, hasRedisRateLimitEnv() (+17 more)
...
Cohesion: 0.25
Nodes (19): acceptSchema, POST(), createInviteToken(), hashInviteToken(), inviteUrlFromRequest(), DELETE(), inviteSchema, POST() (+11 more)
...
Cohesion: 0.15
Nodes (20): CaptureInput, captureProductEvent(), appendAuditLog(), completeOnboardingStep(), createPortalTicket(), getTicket(), getWorkspace(), hydrateTicket() (+12 more)
...
Cohesion: 0.18
Nodes (6): listTickets(), daysOld(), KnowledgePage(), metadata, metadata, PortalPage()
...
Cohesion: 0.13
Nodes (23): ApiAuthResult, getAuthenticatedUser(), requireWorkspaceRole(), canPerformMembershipAction(), CurrentWorkspaceMembership, getCurrentEnterpriseUser, getCurrentWorkspaceMembership, hasEnterpriseRole() (+15 more)

### Community 86 - "Community 86"
Cohesion: 0.2
Nodes (14): ensurePortalIdentity(), requireTicketWorkspaceRole(), appendTicketMessage(), getAiRun(), mapAiRun(), updateAiRunDecision(), DecisionSchema, PATCH() (+6 more)
...
Cohesion: 0.08
Nodes (44): BILLING_PLANS, BillingPlanDefinition, BillingPlanKey, BillingRouteCost, BillingSnapshot, BillingSnapshotInput, BillingUsageMetric, buildBillingSnapshot() (+36 more)
...
Cohesion: 0.53
Nodes (4): listIntegrationDeliveries(), listOutboundEvents(), listSecurityEvents(), GET()
...
Cohesion: 0.18
Nodes (7): listAgents(), TicketList(), TicketListProps, TicketStatus, metadata, SearchParams, TicketsPage()
...
## Knowledge Gaps
- **827 isolated node(s):** `config`, `config`, `SupportPilotTheme`, `nextConfig`, `metadata` (+822 more)
...
- **Why does `createSupabaseAdminClient()` connect `Community 77` to `Community 1`, `Community 3`, `Community 4`, `Community 7`, `Community 15`, `Community 31`, `Community 49`, `Community 52`, `Community 61`, `Community 62`, `Community 63`, `Community 66`, `Community 79`, `Community 80`, `Community 81`, `Community 83`, `Community 85`, `Community 86`, `Community 90`, `Community 93`, `Community 100`, `Community 102`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `getWorkspace()` connect `Community 80` to `Community 1`, `Community 66`, `Community 3`, `Community 4`, `Community 100`, `Community 7`, `Community 74`, `Community 77`, `Community 15`, `Community 81`, `Community 52`, `Community 85`, `Community 90`, `Community 63`, `Community 62`, `Community 31`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `requireWorkspaceRole()` connect `Community 85` to `Community 1`, `Community 66`, `Community 100`, `Community 70`, `Community 7`, `Community 77`, `Community 79`, `Community 80`, `Community 86`, `Community 90`, `Community 31`, `Community 62`, `Community 63`?**
