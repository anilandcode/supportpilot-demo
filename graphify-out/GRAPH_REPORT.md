...
## Corpus Check
- 228 files · ~173,921 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1900 nodes · 3739 edges · 98 communities (90 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e64c0545`
...
1. `createSupabaseAdminClient()` - 105 edges
2. `getWorkspace()` - 86 edges
3. `requireWorkspaceRole()` - 47 edges
4. `appendAuditLog()` - 31 edges
5. `POST()` - 28 edges
6. `cn()` - 26 edges
...
Cohesion: 0.1
Nodes (28): BILLING_PLANS, BillingPlanDefinition, BillingPlanKey, BillingRouteCost, BillingSnapshot, BillingSnapshotInput, BillingUsageMetric, buildBillingSnapshot() (+20 more)
...
Cohesion: 0.18
Nodes (18): ApprovalsPage(), getWorkspaceHealth(), getWorkspaceLaunchState(), listApprovalPolicies(), listApprovalQueue(), listAuditLogs(), listGoldenQuestions(), listMissingKnowledgeTasks() (+10 more)
...
Cohesion: 0.13
Nodes (18): createPortalTicket(), hydrateTicket(), maybeUuid(), resolveCustomerId(), resolvePortalCustomer(), toAgentRunRow(), toAiRunRow(), toAuditLogRow() (+10 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (58): contentHash(), localState, mapDocumentChunk(), TicketFilters, checklist, demoAgentRuns, demoAiRuns, demoApprovalPolicies (+50 more)
...
Cohesion: 0.06
Nodes (33): AgentRun, AIFeedback, ApprovalPolicy, AuditLog, Customer, DeletionRequestStatus, DocumentChunk, EscalationRule (+25 more)
...
Cohesion: 0.22
Nodes (19): enqueueApprovalRequested(), appendAgentRun(), appendGroundingCheck(), appendPolicyEvaluation(), appendToolCall(), createAiRun(), createKnowledgeDocument(), createModelRouteLog() (+11 more)
...
Cohesion: 0.16
Nodes (11): listAgents(), ConfidenceBreakdown, TicketPriority, TicketStatus, metadata, SearchParams, TicketsPage(), calculateConfidenceBreakdown() (+3 more)
...
Cohesion: 0.11
Nodes (31): createDeletionRequest(), CreateDeletionRequestInput, CreateEvidenceExportInput, createRetentionJob(), getDeletionRequest(), getLocalRetentionState(), getRetentionJob(), localRetentionState (+23 more)

### Community 63 - "Community 63"
Cohesion: 0.07
Nodes (59): resolvePlanForWorkspace(), getChunksForReembedding(), localEmbeddingJobs, mapDocumentChunk(), maybeUuid(), publicId(), runReembeddingJob(), toEmbeddingJobRow() (+51 more)
...
Cohesion: 0.05
Nodes (73): acceptSchema, POST(), ApiAuthResult, ensurePortalIdentity(), getAuthenticatedUser(), createInviteToken(), hashInviteToken(), inviteUrlFromRequest() (+65 more)
...
Cohesion: 0.14
Nodes (26): AuditExportSchema, GET(), POST(), requireWorkspaceRole(), listEmbeddingJobs(), listIngestionJobs(), listIntegrationDeliveries(), listOutboundEvents() (+18 more)
...
Cohesion: 0.12
Nodes (34): clientKey(), GET(), createWidgetSession(), getWidgetConfig(), isOriginAllowed(), mapWidgetConfig(), toWidgetSessionRow(), bucketKey() (+26 more)

### Community 81 - "Community 81"
Cohesion: 0.17
Nodes (20): estimateTokenCount(), ModelRouteDecision, RouteInput, selectModelRoute(), assistantResponse(), containsSensitiveData(), getClientKey(), getTextContent() (+12 more)
...
Cohesion: 0.24
Nodes (14): requireTicketWorkspaceRole(), buildApprovalPayload(), enqueueApprovalDecision(), appendTicketMessage(), getAiRun(), getTicket(), mapAiRun(), updateAiRunDecision() (+6 more)
...
Cohesion: 0.39
Nodes (8): getLocalIntegrationState(), publicId(), resetLocalIntegrationStateForTests(), upsertIntegrationAccount(), upsertWebhookEndpoint(), checks, fakeAiRun(), main()
...
Cohesion: 0.31
Nodes (7): CaptureInput, captureProductEvent(), appendAuditLog(), EscalationEmailSchema, POST(), EscalationEmailInput, sendEscalationEmail()
...
## Knowledge Gaps
- **761 isolated node(s):** `config`, `config`, `SupportPilotTheme`, `nextConfig`, `metadata` (+756 more)
...
- **Why does `createSupabaseAdminClient()` connect `Community 71` to `Community 0`, `Community 1`, `Community 7`, `Community 23`, `Community 24`, `Community 31`, `Community 49`, `Community 52`, `Community 62`, `Community 63`, `Community 74`, `Community 76`, `Community 77`, `Community 79`, `Community 80`, `Community 81`, `Community 83`, `Community 85`, `Community 89`, `Community 90`, `Community 93`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `getWorkspace()` connect `Community 74` to `Community 0`, `Community 1`, `Community 4`, `Community 71`, `Community 7`, `Community 79`, `Community 80`, `Community 81`, `Community 63`, `Community 49`, `Community 85`, `Community 23`, `Community 24`, `Community 89`, `Community 90`, `Community 93`, `Community 62`, `Community 31`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 75` to `Community 3`, `Community 35`, `Community 68`, `Community 5`, `Community 70`?**
