...
| Link customer portal actions to portal identity | PARTIAL | `POST /api/portal/tickets` now requires/creates a `portal_identities` row in Supabase mode and creates/fetches the customer by authenticated email; full portal account pages remain future work. |
